      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-foreground/70 hover:text-dizai-neon-green transition-colors">Guia de Nutrição</a></li>
              <li><a href="#" className="text-foreground/70 hover:text-dizai-neon-green transition-colors">Comunidade</a></li>
              <li><a href="#" className="text-foreground/70 hover:text-dizai-neon-green transition-colors">Planos e Preços</a></li>
              <li><a href="#" className="text-foreground/70 hover:text-dizai-neon-green transition-colors">Dicas e Receitas</a></li>
            </ul>
          </div>

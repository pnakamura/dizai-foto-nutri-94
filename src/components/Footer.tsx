    ...
    <footer className="bg-dizai-dark-blue border-t border-dizai-light-purple/20 py-10 md:py-12 px-4 md:px-8">
      <div className="container mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-foreground/70 hover:text-dizai-neon-green transition-colors text-sm md:text-base block py-1">WhatsApp</a></li>
        ...
        <div className="mt-8 text-center">
          <Button 
            size="lg" 
            className="bg-[#25D366] hover:bg-[#128C7E] text-white whatsapp-button px-6 md:px-8 py-5 w-full md:w-auto animate-pulse-subtle"
          >
            <svg 
        ...
        <div className="mt-8 bg-dizai-deep-purple/40 p-4 md:p-6 rounded-xl border border-dizai-light-purple/20">
          ...
          <div className="mt-6 text-center">
            <Button 
              size="lg"
              className="bg-dizai-light-purple hover:bg-dizai-light-purple/90 text-white transition-colors px-6 md:px-8 py-5 md:py-6 text-sm md:text-base w-full md:w-auto"
            >

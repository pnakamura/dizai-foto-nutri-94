      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            A IA da Ethra transforma uma simples foto em dados valiosos para sua saúde com alta precisão e sem burocracia.
          </p>
        </div>
          ...
          {benefits.map((benefit, index) => (
            <div key={index} className="bg-white rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-shadow">
              <div className="flex justify-center mb-4">
                <div className="p-3 bg-ethra-green/10 rounded-full">
                  {benefit.icon}
                </div>
              </div>
